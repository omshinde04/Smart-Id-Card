  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-slate-950 text-white">
      <motion.div
        ...
        className="w-full max-w-sm sm:max-w-md rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 p-6 sm:p-8 shadow-2xl"
      >
        {/* HEADER */}
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-3 rounded-xl bg-slate-900 border border-white/10 px-4 py-3">
